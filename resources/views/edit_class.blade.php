...
<main>
    <div class="container my-5">
        <div class="bg-light p-5 rounded">
            ...
            <form action="{{ route('update.class', ['id' => $class->id]) }}" method="post" class="px-md-5"
                ...
                <div class="form-group mb-3 row">
                    ...
                    <div class="col-md-10">
                        <input type="text" class="form-control py-2" name="className"
                ...
                <div class="form-group mb-3 row">
                    ...
                    <div class="col-md-10">
                        <input type="number" step="0.1" class="form-control py-2" name="price"
                ...
                <div class="form-group mb-3 row">
                    ...
                    <div class="col-md-10">
                        <input type="number" step="0.1" class="form-control py-2" name="capacity"
                ...
                <div class="form-group mb-3 row">
                    ...
                    <div class="col-md-10">
                        <textarea id="" cols="30" rows="5" class="form-control py-2"
                ...
                <div class="form-group mb-3 row">
                    ...
                    <div class="col-md-10">
                        @if($class->image)
                            <img src="{{ asset($class->image) }}" alt="Current Image" style="max-width: 200px;">
                        @else
                ...
                <div class="form-group mb-3 row">
                    <label for="" class="form-label col-md-2 fw-bold text-md-end">Full:</label>
                    <div class="col-md-10">
                        <input type="checkbox" class="form-check-input" style="padding: 0.7rem;" name="full"
                               {{ old('full', $class->full) ? 'checked' : '' }} />
                    </div>
                </div>
