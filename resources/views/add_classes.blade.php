      ...
      <div class="bg-light p-5 rounded">
        ...
        <form action="{{route('classes.store')}}" method="POST" class="px-md-5"  enctype="multipart/form-data">
          ...
          <div class="form-group mb-3 row">
            ...
            <div class="col-md-10">
              <input type="text" placeholder="English" class="form-control py-2" name="className" value="{{old('className')}}" />
              @error('className')
          ...
          <div class="form-group mb-3 row">
            ...
            <div class="col-md-10">
              <input type="number" step="0.1" placeholder="Enter capacity" class="form-control py-2" name="capacity" value="{{old('capacity')}}" />
              @error('capacity')
              <div class="alert alert-warning">{{($message)}}</div>
              @enderror
            </div>
          ...
          <div class="form-group mb-3 row">
            ...
            <div class="col-md-10">
              <input type="checkbox" class="form-check-input" style="padding: 0.7rem;" name="full" value="1" @checked(old('full'))/>
            </div>
          </div>
