...
<main>
    <div class="container my-5">
        <div class="bg-light p-5 rounded">
            ...
            <form action="{{ route('product.update', ['id' => $product->id]) }}" method="post" class="px-md-5"
                ...
                <div class="form-group mb-3 row">
                    ...
                    <div class="col-md-10">
                        @if($product->image)
                            <img src="{{ asset('assets/images/product/' . $product->image) }}" alt="Current Image" style="max-width: 200px;">
                        @else
